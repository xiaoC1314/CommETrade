...
public class Navigate{
    ...
    public static Object getPageId;
  ...
  private StringBuffer otherCondition = new StringBuffer();
...
public Navigate() {
  ...
  public void setOtherCondition(String otherCondition) {
		this.otherCondition.append(otherCondition);
	}

public String getOtherCondition() {
	return otherCondition.toString();
}
