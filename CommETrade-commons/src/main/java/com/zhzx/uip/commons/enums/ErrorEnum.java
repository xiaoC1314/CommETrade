...
/********************************查询错误信息*****************************************/
	...
	COMM_ORDER_NOT_EXIST_ERR("COMM_ORDER_NOT_EXIST_ERR", "订单不存在"),
	COMM_ORDER_REVOKED_ERR("COMM_ORDER_REVOKED_ERR", "订单已取消"),
	COMM_CAN_NOT_REVOKE_ERR("COMM_CAN_NOT_REVOKE_ERR", "订单当前状态无法取消订单"),
